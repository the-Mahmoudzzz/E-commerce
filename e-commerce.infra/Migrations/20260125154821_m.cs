        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_categories_AspNetUsers_CreatedByAdminId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LifeTimeEarnings = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SellerWallets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SellerWallets_AspNetUsers_SellerId",
                        column: x => x.SellerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_shopingCarts_AspNetUsers_CustmerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WithdrawlsStatus = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_withdrawals_AspNetUsers_SelerId",
                        column: x => x.SelerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiscountCategries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DiscountCategries_Discounts_DiscountId",
                        column: x => x.DiscountId,
                        principalTable: "Discounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DiscountCategries_categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DelevierdDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    OrderId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_shoppingCartItems_shopingCarts_ShoppingCartId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_ShippingZoneId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_categories_CreatedByAdminId",
                table: "categories",
                column: "CreatedByAdminId");

            migrationBuilder.CreateIndex(
                name: "IX_DiscountCategries_CategoryId",
                table: "DiscountCategries",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_DiscountCategries_DiscountId",
                table: "DiscountCategries",
                column: "DiscountId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_shopingCarts_CustmerId",
                table: "shopingCarts",
                column: "CustmerId",
                unique: true);
